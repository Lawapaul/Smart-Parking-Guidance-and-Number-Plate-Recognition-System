...
function Dashboard() {
  ...
  const fetchAllData = async () => {
    try {
      ...
      // Fetch only currently available slots for the dashboard view
      const slotsResponse = await axios.get(`${API_BASE_URL}/parking/slots/available`, {
        timeout: 5000
      });
      ...
      const statsResponse = await axios.get(`${API_BASE_URL}/parking/stats`, {
        timeout: 5000
      });
      ...
      if (statsResponse.data) {
        setStats({
          ...
          available: statsResponse.data.available,
          occupied: statsResponse.data.occupied,
    ...
    <div className="dashboard">
      ...
      <div className="content-grid">
        ...
        <div className="section">
          <h2>🅿️ Available Parking Slots</h2>
          {recommendation?.slot && (
            <div style={{
              marginBottom: '16px',
              padding: '16px',
